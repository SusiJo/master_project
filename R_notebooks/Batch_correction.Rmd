...
# sort sample names of pheno_table with batches according to order in pancreas_data‚
...
# Explained Variance
ev0 <- summary(df_pca_uncorr)
pc1_ev0 <- round((ev0$importance[2,1] *100),1)
pc2_ev0 <- round((ev0$importance[2,2] *100),1)
...
pca_uncorr_c<-pca_uncorr_c+geom_point() +
              xlab(paste("PC1 - " , pc1_ev0, " %")) +
              ylab(paste("PC2 - " , pc2_ev0, " %"))
...
ev01 <- summary(df_pca_combat)
pc1_ev01 <- round((ev01$importance[2,1] *100),1)
pc2_ev01 <- round((ev01$importance[2,2] *100),1)
...
pca_combat_c<-pca_combat_c+geom_point() +
              xlab(paste("PC1 - " , pc1_ev01, " %")) +
              ylab(paste("PC2 - " , pc2_ev01, " %"))
...
ev02 <- summary(df_pca_combat_model)
pc1_ev02 <- round((ev02$importance[2,1] *100),1)
pc2_ev02 <- round((ev02$importance[2,2] *100),1)
...
pca_combat_model_c<-pca_combat_model_c+geom_point() +
                    xlab(paste("PC1 - " , pc1_ev02, " %")) +
                    ylab(paste("PC2 - " , pc2_ev02, " %"))
...
ev03 <- summary(df_pca_combatseq)
pc1_ev03 <- round((ev03$importance[2,1] *100),1)
pc2_ev03 <- round((ev03$importance[2,2] *100),1)
...
pca_combatseq_c<-pca_combatseq_c+geom_point() +
                 xlab(paste("PC1 - " , pc1_ev03, " %")) +
                 ylab(paste("PC2 - " , pc2_ev03, " %"))
...
ggexport(figure1, filename = "/Users/susanne/Downloads/pca_unscaled_condition_project.pdf")
```
...
# Explained Variance
ev1 <- summary(df_pca_uncorr_scaled)
pc1_ev1 <- round((ev1$importance[2,1] *100),1)
pc2_ev1 <- round((ev1$importance[2,2] *100),1)
...
pca_uncorr_scaled_c<-pca_uncorr_scaled_c+geom_point() + 
                     xlab(paste("PC1 - " , pc1_ev1, " %")) +
                    ylab(paste("PC2 - " , pc2_ev1, " %"))
...
ev2 <- summary(pca_combat_sc)
pc1_ev2 <- round((ev2$importance[2,1] *100),1)
pc2_ev2 <- round((ev2$importance[2,2] *100),1)
...
pca_combat_sc_c<-pca_combat_sc_c+geom_point() +
                 xlab(paste("PC1 - " , pc1_ev2, " %")) +
                 ylab(paste("PC2 - " , pc2_ev2, " %"))
...
ev3 <- summary(pca_combat_model_sc)
pc1_ev3 <- round((ev3$importance[2,1] *100),1)
pc2_ev3 <- round((ev3$importance[2,2] *100),1)
...
pca_combat_model_sc_c<-pca_combat_model_sc_c+geom_point() +
                      xlab(paste("PC1 - " , pc1_ev3, " %")) +
                      ylab(paste("PC2 - " , pc2_ev3, " %"))
...
ev4 <- summary(pca_combatseq_sc)
pc1_ev4 <- round((ev4$importance[2,1] *100),1)
pc2_ev4 <- round((ev4$importance[2,2] *100),1)
...
pca_combatseq_sc_c<-pca_combatseq_sc_c+geom_point() +
                    xlab(paste("PC1 - " , pc1_ev4, " %")) +
                    ylab(paste("PC2 - " , pc2_ev4, " %"))
...
# PCA uncorrected data
df_pca_uncorr_scaled <- prcomp(df_uncorr_scaled)
ev5 <- summary(df_pca_uncorr_scaled)
pc3_ev5 <- round((ev5$importance[2,3] *100),1)
pc4_ev5 <- round((ev5$importance[2,4] *100),1)

# plot PCA per condition
df_out_uncorr_scaled <- as.data.frame(df_pca_uncorr_scaled$x)
df_out_uncorr_scaled$condition <- sample_condition
pca_uncorr_scaled_c<-ggplot(df_out_uncorr_scaled,aes(x=PC3,y=PC4,color=condition ))
pca_uncorr_scaled_c<-pca_uncorr_scaled_c+geom_point() +
                       xlab(paste("PC3 - " , pc3_ev5, " %")) +
                       ylab(paste("PC4 - " , pc4_ev5, " %"))

# PCA per project
df_out_uncorr_scaled <- as.data.frame(df_pca_uncorr_scaled$x)
df_out_uncorr_scaled$project <- sorted_pheno$Project
pca_uncorr_scaled_p<-ggplot(df_out_uncorr_scaled,aes(x=PC3,y=PC4,color=project ))
pca_uncorr_scaled_p<-pca_uncorr_scaled_p+geom_point() + 
                     xlab(paste("PC3 - " , pc3_ev5, " %")) +
                     ylab(paste("PC4 - " , pc4_ev5, " %"))
...
# PCA combat scaled
pca_combat_sc <- prcomp(df_combat_scaled)
ev6 <- summary(pca_combat_sc)
pc3_ev6 <- round((ev6$importance[2,3] *100),1)
pc4_ev6 <- round((ev6$importance[2,4] *100),1)

# PCA combat per condition
df_out_combat_sc <- as.data.frame(pca_combat_sc$x)
df_out_combat_sc$condition <- sample_condition
pca_combat_sc_c<-ggplot(df_out_combat_sc,aes(x=PC3,y=PC4,color=condition ))
pca_combat_sc_c<-pca_combat_sc_c+geom_point() +
                    xlab(paste("PC3 - " , pc3_ev6, " %")) +
                     ylab(paste("PC4 - " , pc4_ev6, " %"))

# PCA combat per project

df_out_combat_sc <- as.data.frame(pca_combat_sc$x)
df_out_combat_sc$project <- sorted_pheno$Project
pca_combat_sc_p<-ggplot(df_out_combat_sc,aes(x=PC3,y=PC4,color=project ))
pca_combat_sc_p<-pca_combat_sc_p+geom_point() +
                    xlab(paste("PC3 - " , pc3_ev6, " %")) +
                    ylab(paste("PC4 - " , pc4_ev6, " %"))
...
# PCA combat model scaled
pca_combat_model_sc <- prcomp(df_combat_model_scaled)
ev7 <- summary(pca_combat_model_sc)
pc3_ev7 <- round((ev7$importance[2,3] *100),1)
pc4_ev7 <- round((ev7$importance[2,4] *100),1)

# PCA combat per condition
df_out_combat_model_sc <- as.data.frame(pca_combat_model_sc$x)
df_out_combat_model_sc$condition <- sample_condition
pca_combat_model_sc_c<-ggplot(df_out_combat_model_sc,aes(x=PC3,y=PC4,color=condition ))
pca_combat_model_sc_c<-pca_combat_model_sc_c+geom_point() +
                      xlab(paste("PC3 - " , pc3_ev7, " %")) +
                      ylab(paste("PC4 - " , pc4_ev7, " %"))
...
df_out_combat_model_sc <- as.data.frame(pca_combat_model_sc$x)
df_out_combat_model_sc$project <- sorted_pheno$Project
pca_combat_model_sc_p<-ggplot(df_out_combat_model_sc,aes(x=PC3,y=PC4,color=project ))
pca_combat_model_sc_p<-pca_combat_model_sc_p+geom_point() +
                       xlab(paste("PC3 - " , pc3_ev7, " %")) +
                       ylab(paste("PC4 - " , pc4_ev7, " %"))
...
# PCA combatseq scaled
pca_combatseq_sc <- prcomp(combatseq_t_sc)
ev8 <- summary(pca_combatseq_sc)
pc3_ev8 <- round((ev8$importance[2,3] *100),1)
pc4_ev8 <- round((ev8$importance[2,4] *100),1)

# PCA combatseq per condition
df_combatseq_sc <- as.data.frame(pca_combatseq_sc$x)
df_combatseq_sc$condition <- sample_condition
pca_combatseq_sc_c<-ggplot(df_combatseq_sc,aes(x=PC3,y=PC4,color=condition ))
pca_combatseq_sc_c<-pca_combatseq_sc_c+geom_point() +
                     xlab(paste("PC3 - " , pc3_ev8, " %")) +
                     ylab(paste("PC4 - " , pc4_ev8, " %"))

# PCA combatseq per project

df_combatseq_sc <- as.data.frame(pca_combatseq_sc$x)
df_combatseq_sc$project <- sorted_pheno$Project
pca_combatseq_sc_p<-ggplot(df_combatseq_sc,aes(x=PC3,y=PC4,color=project ))
pca_combatseq_sc_p<-pca_combatseq_sc_p+geom_point() +
                     xlab(paste("PC3 - " , pc3_ev8, " %")) +
                     ylab(paste("PC4 - " , pc4_ev8, " %"))
#pca_combatseq_sc_p + ggtitle("CombatSeq") 
...
# ----------------------------------------------------------------------------
# draw multipage
figure3 <- ggarrange(pca_uncorr_scaled_c, pca_uncorr_scaled_p,
          pca_combat_sc_c, pca_combat_sc_p,
          pca_combat_model_sc_c, pca_combat_model_sc_p,
          pca_combatseq_sc_c, pca_combatseq_sc_p,
          labels = c("U", "U", 
...
figure3 <- annotate_figure(figure3, top = text_grob("PCA of MinMax-scaled data removing first two PCs", color = "black", face = "bold", size = 12))

ggexport(figure3, filename = "/Users/susanne/Downloads/pca_scaled_condition_project_removedPC1PC2.pdf")
...
# 1) RemoveBatchEffect
rbe <- removeBatchEffect(expr_df, batch_pancreas, design=mod)

# 2) convert to TPM
rbe_tpm <- apply(rbe, 2, tpm, lengths=sorted_gene_lengths$GeneLength)

# 3) Convert to df
df_rbe_tpm <- data.frame(rbe_tpm)

# 4) Transpose 
df_rbe_tpm_t <- transpose(df_rbe_tpm)


# 5) Scaling with MinMax
df_rbe_scaled <- apply(df_rbe_tpm_t, 2, normalize, -1,1)

# 6) replace infinity and is.na with 0
is.na(df_rbe_scaled) <- sapply(df_rbe_scaled, is.infinite)
df_rbe_scaled[is.na(df_rbe_scaled)] <- 0

# PCA and explained Variance
pca_rbe <- prcomp(df_rbe_scaled)
ev9 <- summary(pca_rbe)
pc1_ev9 <- round((ev9$importance[2,1] *100),1)
pc2_ev9 <- round((ev9$importance[2,2] *100),1)

# plot PCA per condition
df_out_rbe <- as.data.frame(pca_rbe$x)
df_out_rbe$condition <- sample_condition
rbe_plot_c<-ggplot(df_out_rbe,aes(x=PC1,y=PC2,color=condition ))
rbe_plot_c<-rbe_plot_c+geom_point() +
                       xlab(paste("PC1 - " , pc1_ev9, " %")) +
                       ylab(paste("PC2 - " , pc2_ev9, " %"))

# PCA per project
df_out_rbe <- as.data.frame(pca_rbe$x)
df_out_rbe$project <- sorted_pheno$Project
rbe_plot_p<-ggplot(df_out_rbe,aes(x=PC1,y=PC2,color=project ))
rbe_plot_p<-rbe_plot_p+geom_point() +
                       xlab(paste("PC1 - " , pc1_ev9, " %")) +
                       ylab(paste("PC2 - " , pc2_ev9, " %"))
...
# draw multipage
figure4 <- ggarrange(pca_uncorr_scaled_c, pca_uncorr_scaled_p,
          pca_combat_sc_c, pca_combat_sc_p,
          pca_combat_model_sc_c, pca_combat_model_sc_p,
          pca_combatseq_sc_c, pca_combatseq_sc_p,
          rbe_plot_c, rbe_plot_p,
          labels = c("U", "U", 
                     "C", "C",
                     "CM", "CM",
                     "CS", "CS",
...
figure4 <- annotate_figure(figure4, top = text_grob("PCA of MinMax-scaled data", color = "black", face = "bold", size = 12))

ggexport(figure4, filename = "/Users/susanne/Downloads/pca_scaled_condition_project_new.pdf")


row.names(df_rbe_tpm_t) <- sample_names
colnames(df_rbe_tpm_t) <- gene_id
